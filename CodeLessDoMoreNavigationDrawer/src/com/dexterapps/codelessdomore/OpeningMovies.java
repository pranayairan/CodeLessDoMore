...
public class OpeningMovies extends BaseActivity implements OnRefreshListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		getSupportActionBar().setTitle("Opening Movies");
		populateNavigationDrawer("Opening Movies");
	...
	private void getMovieRatings()
	{
				...
				Callback<BoxOfficeMovies> callback = new Callback<BoxOfficeMovies>() {
				    ...
				    public void success(BoxOfficeMovies movies, Response response) {
				    	...
				    	BoxOfficeMovieAdapter movieAdapter = new BoxOfficeMovieAdapter(OpeningMovies.this, movies.getMovies());
